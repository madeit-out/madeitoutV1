...
export const airports = [
  // North America
  { name: "New York - John F. Kennedy International Airport", code: "JFK" },
  ...
  { name: "Atlanta Hartsfield-Jackson International Airport", code: "ATL" },
  ...
  { name: "Madrid-Barajas Adolfo Suárez Airport", code: "MAD" },
  { name: "Rome Fiumicino Leonardo da Vinci Airport", code: "FCO" },
  ...
  { name: "Bogotá El Dorado International Airport", code: "BOG" },
  { name: "Lima Jorge Chávez International Airport", code: "LIM" },
  { name: "Santiago Arturo Merino Benítez Airport", code: "SCL" },
  {
